...
@NamedQueries({
    ...
    , @NamedQuery(name = "DatosMedicos.findByEdad", query = "SELECT d FROM DatosMedicos d WHERE d.edad = :edad")
...
public class DatosMedicos implements Serializable {
    ...
    public DatosMedicos(Integer idDatosMedicos, BigDecimal peso, BigDecimal altura, String edad, String tipoSangre) {
        this.idDatosMedicos = idDatosMedicos;
        this.peso = peso;
        this.altura = altura;
        this.edad = edad;
    ...
    public String toString() {
        return "persistencia.DatosMedicos[ idDatosMedicos=" + idDatosMedicos + " ]";
    }
